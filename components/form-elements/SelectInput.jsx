...
const SelectInput = ({ label, options, onChange, classs, value, place, big, isDisabled, light,important }) => {

  //const sel = big?selectStyle2:selectStyle

  return (
    <InputLabelCon className={classs}>
      {light?<Label2>{label}{!important&&<span>*</span>}</Label2>:<Label>{label}{!important&&<span>*</span>}</Label>}
